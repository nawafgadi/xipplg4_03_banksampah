...
<body>
    ...
    <nav class="navbar-kumparan">
        <div class="nav-main">
            <div class="nav-logo">
                <img src="logo gunung lencana biru minimalis.png" alt="Logo">
    ...
    <section class="education-section">
        ...
        <div class="education-container">
            <div class="education-card">
                <img src="perumahan buangan.jpeg" alt="Daur Ulang Plastik">
            ...
            <div class="education-card">
                <img src="edukasi.jpeg" alt="Daur Ulang Kertas">
            ...
            <div class="education-card">
                <img src="daur ulang.jpeg" alt="Kompos Organik">
    ...
    <section class="gallery-section">
        ...
        <div class="gallery-container">
            <div class="gallery-item active">
                <img src="aksi-bersih-sampah 1.jpeg" alt="Kegiatan Bank Sampah 1">
                <div class="caption">Kegiatan bersih bersih sampah yang rutin kita lakukan </div>
            </div>
            <div class="gallery-item">
                <img src="pengangkutan-sampah.jpg" alt="Kegiatan Bank Sampah 2">
                <div class="caption">Penjemputan Sampah dari Warga</div>
            </div>
            <div class="gallery-item">
                <img src="daur_ulang_sampah_plastik.jpg" alt="Kegiatan Bank Sampah 2">
                <div class="caption">Proses daur ulang sampah di Bank Sampah</div>    
            </div>
            <div class="gallery-item">
                <img src="sedang_1531805177WhatsApp Image 2018-07-17 at 12.57.48.jpeg" alt="Kegiatan Bank Sampah 3">
